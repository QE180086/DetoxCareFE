...
const allProducts = [
  ...
  { id: 2, name: 'Cần tây + Táo + Dưa leo', category: 'Detox', price: 28000, image: 'https://omegajuicers.vn/wp-content/uploads/2023/11/nuoc-ep-can-tay-dua-tao-dua-chuot.jpg', rating: (Math.random() * 4 + 1).toFixed(1), purchases: Math.floor(Math.random() * 1000) + 100 },
  { id: 3, name: 'Cần tây + Táo + Thơm', category: 'Detox', price: 28000, image: 'https://file.hstatic.net/200000342937/file/cach-lam-nuoc-ep-can-tay-va-tao_5c4f1de76ead47fcb48938416aca2e17_grande.jpg', rating: (Math.random() * 4 + 1).toFixed(1), purchases: Math.floor(Math.random() * 1000) + 100 },
  { id: 4, name: 'Cần tây + Thơm', category: 'Detox', price: 25000, image: 'https://suckhoedoisong.qltns.mediacdn.vn/324455921873985536/2024/4/22/nuoc-ep-can-tay-1713756549662927698966.jpg', rating: (Math.random() * 4 + 1).toFixed(1), purchases: Math.floor(Math.random() * 1000) + 100 },
  { id: 5, name: 'Thơm + Táo + Dưa leo + Cà rốt', category: 'Detox', price: 30000, image: 'https://suckhoedoisong.qltns.mediacdn.vn/324455921873985536/2024/4/22/nuoc-ep-can-tay-1713756549662927698966.jpg', rating: (Math.random() * 4 + 1).toFixed(1), purchases: Math.floor(Math.random() * 1000) + 100 },
  // Combo 3 ngày (85k)
  ...
  { id: 7, name: 'Combo 3 ngày - Ngày 2', category: 'Combo 3 ngày', price: 85000, image: 'https://vivita.cdn.vccloud.vn/wp-content/uploads/2022/08/nuoc-ep-detox.jpg', rating: (Math.random() * 4 + 1).toFixed(1), purchases: Math.floor(Math.random() * 1000) + 100, description: 'Cần tây + Táo + Thơm' },
  { id: 8, name: 'Combo 3 ngày - Ngày 3', category: 'Combo 3 ngày', price: 85000, image: 'https://chaipetsaigon.com/wp-content/uploads/2021/03/10-cong-thuc-lam-nuoc-ep-detox.jpg', rating: (Math.random() * 4 + 1).toFixed(1), purchases: Math.floor(Math.random() * 1000) + 100, description: 'Thơm + Táo + Dưa leo + Cà rốt' },
  // Combo 5 ngày (135k)
  { id: 9, name: 'Combo 5 ngày - Ngày 1', category: 'Combo 5 ngày', price: 135000, image: 'https://sieuthiyte.com.vn/blog/wp-content/uploads/2024/12/detox-chanh-dua-leo-nen-uong-bua-sang.jpg', rating: (Math.random() * 4 + 1).toFixed(1), purchases: Math.floor(Math.random() * 1000) + 100, description: 'Cần tây + Táo + Dưa leo' },
  ...
  { id: 12, name: 'Combo 5 ngày - Ngày 4', category: 'Combo 5 ngày', price: 135000, image: 'https://file.hstatic.net/200000240163/article/combo_5_ngay_4_1k2l3m4n5o6p7q8r_1024x1024.jpg', rating: (Math.random() * 4 + 1).toFixed(1), purchases: Math.floor(Math.random() * 1000) + 100, description: 'Cần tây + Thơm' },
  { id: 13, name: 'Combo 5 ngày - Ngày 5', category: 'Combo 5 ngày', price: 135000, image: 'https://file.hstatic.net/200000240163/article/combo_5_ngay_5_2l3m4n5o6p7q8r9s_1024x1024.jpg', rating: (Math.random() * 4 + 1).toFixed(1), purchases: Math.floor(Math.random() * 1000) + 100, description: 'Cần tây + Táo + Thơm' },
  // Combo 7 ngày (189k)
  { id: 14, name: 'Combo 7 ngày - Ngày 1', category: 'Combo 7 ngày', price: 189000, image: 'https://sieuthiyte.com.vn/blog/wp-content/uploads/2024/12/detox-chanh-dua-leo-nen-uong-bua-sang.jpg', rating: (Math.random() * 4 + 1).toFixed(1), purchases: Math.floor(Math.random() * 1000) + 100, description: 'Cần tây + Táo + Dưa leo' },
  { id: 15, name: 'Combo 7 ngày - Ngày 2', category: 'Combo 7 ngày', price: 189000, image: 'https://sieuthiyte.com.vn/blog/wp-content/uploads/2024/12/detox-chanh-dua-leo-nen-uong-bua-sang.jpg', rating: (Math.random() * 4 + 1).toFixed(1), purchases: Math.floor(Math.random() * 1000) + 100, description: 'Củ dền + Cà rốt + Táo + Dưa leo' },
  { id: 16, name: 'Combo 7 ngày - Ngày 3', category: 'Combo 7 ngày', price: 189000, image: 'https://vivita.cdn.vccloud.vn/wp-content/uploads/2022/08/nuoc-ep-detox.jpg', rating: (Math.random() * 4 + 1).toFixed(1), purchases: Math.floor(Math.random() * 1000) + 100, description: 'Cần tây + Thơm' },
  { id: 17, name: 'Combo 7 ngày - Ngày 4', category: 'Combo 7 ngày', price: 189000, image: 'https://vivita.cdn.vccloud.vn/wp-content/uploads/2022/08/nuoc-ep-detox.jpg', rating: (Math.random() * 4 + 1).toFixed(1), purchases: Math.floor(Math.random() * 1000) + 100, description: 'Thơm + Táo + Dưa leo + Cà rốt' },
  ...
  { id: 20, name: 'Combo 7 ngày - Ngày 7', category: 'Combo 7 ngày', price: 189000, image: 'https://sieuthiyte.com.vn/blog/wp-content/uploads/2024/12/detox-chanh-dua-leo-nen-uong-bua-sang.jpg', rating: (Math.random() * 4 + 1).toFixed(1), purchases: Math.floor(Math.random() * 1000) + 100, description: 'Thơm + Táo + Dưa leo + Cà rốt' },
  ...
  { id: 27, name: 'Combo 3 ngày - Phiên bản Đặc biệt', category: 'Combo 3 ngày', price: 85000, image: 'https://file.hstatic.net/200000240163/article/combo_3_ngay_dac_biet_6z7a8b9c0d1e2f3g_1024x1024.jpg', rating: (Math.random() * 4 + 1).toFixed(1), purchases: Math.floor(Math.random() * 1000) + 100, description: 'Củ dền + Cà rốt + Táo + Dưa leo' },
  { id: 28, name: 'Combo 5 ngày - Phiên bản Đặc biệt', category: 'Combo 5 ngày', price: 135000, image: 'https://file.hstatic.net/200000240163/article/combo_5_ngay_dac_biet_7a8b9c0d1e2f3g4h_1024x1024.jpg', rating: (Math.random() * 4 + 1).toFixed(1), purchases: Math.floor(Math.random() * 1000) + 100, description: 'Cần tây + Táo + Dưa leo' },
